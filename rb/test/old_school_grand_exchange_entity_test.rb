...
class OldSchoolGrandExchangeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set RUNESCAPEAPIS_TEST_OLD_SCHOOL_GRAND_EXCHANGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def old_school_grand_exchange_basic_setup(extra)
  ...
  entid_env_raw = ENV["RUNESCAPEAPIS_TEST_OLD_SCHOOL_GRAND_EXCHANGE_ENTID"]
