...
class PlayerRankingEntity
  ...
  def make
    opts = @_entopts.dup
    PlayerRankingEntity.new(@_client, opts)
  end
  ...
  # @return [PlayerRanking, Hash] the current PlayerRanking data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PlayerRanking fields)
  def match_get
  ...
  #
  # @param reqmatch [PlayerRankingListMatch, Hash, nil] match filter (any subset of
  #   PlayerRanking fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PlayerRanking>, Array] the matching PlayerRanking items; raises RunescapeApisError on failure
