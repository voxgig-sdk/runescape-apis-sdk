...
func registerSDKWords(r *eng.Registry, client *sdk.RunescapeApisSDK) {
...
func runOp(client *sdk.RunescapeApisSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
