...
boru-driven command-line client **and** interactive REPL for the RunescapeApis
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `grand_exchange_database`).
