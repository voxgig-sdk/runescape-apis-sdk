...
// RunescapeApis SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RunescapeApisSDK::test)
...
{
    private const SDK_CLASS = 'RunescapeApisSDK';
    ...
    private const SDK_BASE = 'runescapeapis_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../runescapeapis_sdk.php';
