...
class OldSchoolGrandExchangeDirectTest extends TestCase
{
    public function test_direct_list_old_school_grand_exchange(): void
    {
        $setup = old_school_grand_exchange_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-old_school_grand_exchange", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
