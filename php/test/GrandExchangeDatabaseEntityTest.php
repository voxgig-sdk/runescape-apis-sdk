...
class GrandExchangeDatabaseEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->GrandExchangeDatabase(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->GrandExchangeDatabase(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RUNESCAPE_APIS_TEST_GRAND_EXCHANGE_DATABASE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $grand_exchange_database_ref01_data_dt0_load_result = Helpers::to_map(is_object($grand_exchange_database_ref01_data_dt0_loaded) && method_exists($grand_exchange_database_ref01_data_dt0_loaded, 'data_get') ? $grand_exchange_database_ref01_data_dt0_loaded->data_get() : $grand_exchange_database_ref01_data_dt0_loaded);
...
function grand_exchange_database_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RUNESCAPE_APIS_TEST_GRAND_EXCHANGE_DATABASE_ENTID");
