...
// RunescapeApis SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = RunescapeApisOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(RunescapeApisOmni::structfix($now, Struct::undef()))
                        !== json_encode(RunescapeApisOmni::structfix($val, Struct::undef()))) {
