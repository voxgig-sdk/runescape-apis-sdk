...
class PlayerRankingDirectTest extends TestCase
{
    public function test_direct_list_player_ranking(): void
    {
        $setup = player_ranking_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-player_ranking", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
