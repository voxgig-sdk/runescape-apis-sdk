...
// RunescapeApis SDK debug feature
...
class RunescapeApisDebugFeature extends RunescapeApisBaseFeature
{
    ...
    private function _finish(RunescapeApisContext $ctx, bool $ok): void
    {
