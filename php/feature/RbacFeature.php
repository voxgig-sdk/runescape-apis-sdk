...
// RunescapeApis SDK rbac feature
...
class RunescapeApisRbacFeature extends RunescapeApisBaseFeature
{
    ...
    private function _required(RunescapeApisContext $ctx): ?string
    {
    ...
    private function _reject(RunescapeApisContext $ctx, string $required): void
    {
    ...
    private function _track(RunescapeApisContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
