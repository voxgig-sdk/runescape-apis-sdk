...
// RunescapeApis SDK telemetry feature
...
class RunescapeApisTelemetryFeature extends RunescapeApisBaseFeature
{
    ...
    private function _close(RunescapeApisContext $ctx, bool $ok): void
    {
