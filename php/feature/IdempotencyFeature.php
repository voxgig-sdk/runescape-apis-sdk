...
// RunescapeApis SDK idempotency feature
...
class RunescapeApisIdempotencyFeature extends RunescapeApisBaseFeature
{
    ...
    private function _mutating(RunescapeApisContext $ctx): bool
    {
