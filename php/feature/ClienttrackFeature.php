...
// RunescapeApis SDK clienttrack feature
...
class RunescapeApisClienttrackFeature extends RunescapeApisBaseFeature
{
    ...
    public function PostConstruct(RunescapeApisContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RunescapeApis-SDK';
