...
// RunescapeApis SDK ratelimit feature
...
class RunescapeApisRatelimitFeature extends RunescapeApisBaseFeature
{
    ...
    private function _acquire(RunescapeApisContext $ctx): void
    {
    ...
    private function _track(RunescapeApisContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
