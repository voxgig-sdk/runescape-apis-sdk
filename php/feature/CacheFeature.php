...
// RunescapeApis SDK cache feature
...
class RunescapeApisCacheFeature extends RunescapeApisBaseFeature
{
    ...
    private function _through(RunescapeApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
