...
// RunescapeApis SDK timeout feature
...
class RunescapeApisTimeoutFeature extends RunescapeApisBaseFeature
{
    ...
    private function _with_timeout(RunescapeApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RunescapeApisContext $_ctx, float $ms): void
    {
        $client = $this->client;
