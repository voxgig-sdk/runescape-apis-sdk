...
// RunescapeApis SDK audit feature
...
class RunescapeApisAuditFeature extends RunescapeApisBaseFeature
{
    ...
    private function _emit(RunescapeApisContext $ctx, string $outcome): void
    {
