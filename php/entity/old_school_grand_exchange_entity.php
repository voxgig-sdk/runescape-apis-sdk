...
// RunescapeApis SDK OldSchoolGrandExchange entity
...
class OldSchoolGrandExchangeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "old_school_grand_exchange";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OldSchoolGrandExchangeEntity($this->_client, $opts);
    }

    /**
     * @param OldSchoolGrandExchange|array $args OldSchoolGrandExchange data (assoc-array) to store.
     */
    ...
    /**
     * @return OldSchoolGrandExchange|array The current OldSchoolGrandExchange data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OldSchoolGrandExchange fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OldSchoolGrandExchange fields).
     */
     ...
     *
     * @param OldSchoolGrandExchangeListMatch|array|null $reqmatch Match filter (any subset
     *   of OldSchoolGrandExchange fields) as an assoc-array; OldSchoolGrandExchangeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OldSchoolGrandExchange[]|array A list of OldSchoolGrandExchange items as assoc-arrays at
