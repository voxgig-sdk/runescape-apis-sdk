...
// RunescapeApis SDK utility type

class RunescapeApisUtility
{
    ...
    public static function copy(RunescapeApisUtility $src): RunescapeApisUtility
    {
        $u = new RunescapeApisUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
