...
// RunescapeApis SDK utility: graphql
//
...
class RunescapeApisGraphql
{
    ...
    // equivalent.
    public static function body(RunescapeApisContext $ctx): mixed
    {
    ...
    public static function errors(RunescapeApisContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
