...
// RunescapeApis SDK utility: fetcher

class RunescapeApisFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RunescapeApisSDK/1.0)';
    ...
    public static function call(RunescapeApisContext $ctx, string $fullurl, array $fetchdef): array
    {
