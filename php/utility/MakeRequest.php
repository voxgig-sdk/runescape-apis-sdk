...
// RunescapeApis SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RunescapeApisMakeRequest
{
    public static function call(RunescapeApisContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RunescapeApisResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RunescapeApisResponse($fetched);
        } else {
