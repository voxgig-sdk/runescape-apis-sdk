...
// RunescapeApis SDK utility: make_options

class RunescapeApisMakeOptions
{
    ...
    public static function call(RunescapeApisContext $ctx): array
    {
        ...
        //
        // `RunescapeApisSchema::optspec()` is built from the model:
        ...
        $optspec = RunescapeApisSchema::optspec();
