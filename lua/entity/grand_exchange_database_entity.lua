...
local GrandExchangeDatabaseEntity = {}
GrandExchangeDatabaseEntity.__index = GrandExchangeDatabaseEntity


function GrandExchangeDatabaseEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GrandExchangeDatabaseEntity)
  self._name = "grand_exchange_database"
  self._client = client
...
function GrandExchangeDatabaseEntity:get_name()
  return self._name
end


function GrandExchangeDatabaseEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GrandExchangeDatabaseEntity.new(self._client, opts)
end
...
function GrandExchangeDatabaseEntity:mark_deleted()
  self._deleted = true
end


function GrandExchangeDatabaseEntity:deleted()
  return true == self._deleted
end


function GrandExchangeDatabaseEntity:data_set(args)
  if args ~= nil then
...
function GrandExchangeDatabaseEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GrandExchangeDatabaseEntity:match_set(args)
  if args ~= nil then
...
function GrandExchangeDatabaseEntity:match_get()
...
function GrandExchangeDatabaseEntity:stream(action, args, callopts)
...
function GrandExchangeDatabaseEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GrandExchangeDatabaseEntity
