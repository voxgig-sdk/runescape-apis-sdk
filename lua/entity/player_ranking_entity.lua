...
local PlayerRankingEntity = {}
PlayerRankingEntity.__index = PlayerRankingEntity


function PlayerRankingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlayerRankingEntity)
  self._name = "player_ranking"
  self._client = client
...
function PlayerRankingEntity:get_name()
  return self._name
end


function PlayerRankingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlayerRankingEntity.new(self._client, opts)
end
...
function PlayerRankingEntity:mark_deleted()
  self._deleted = true
end


function PlayerRankingEntity:deleted()
  return true == self._deleted
end


function PlayerRankingEntity:data_set(args)
  if args ~= nil then
...
function PlayerRankingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlayerRankingEntity:match_set(args)
  if args ~= nil then
...
function PlayerRankingEntity:match_get()
...
function PlayerRankingEntity:stream(action, args, callopts)
...
---@param reqmatch PlayerRankingListMatch
---@param ctrl? table
---@return PlayerRanking[]
---@return string? err
function PlayerRankingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function PlayerRankingEntity:_run_op(ctx, post_done)
  local utility = self._utility
