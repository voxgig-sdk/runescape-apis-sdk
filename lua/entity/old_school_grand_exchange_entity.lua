...
local OldSchoolGrandExchangeEntity = {}
OldSchoolGrandExchangeEntity.__index = OldSchoolGrandExchangeEntity


function OldSchoolGrandExchangeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OldSchoolGrandExchangeEntity)
  self._name = "old_school_grand_exchange"
  self._client = client
...
function OldSchoolGrandExchangeEntity:get_name()
  return self._name
end


function OldSchoolGrandExchangeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OldSchoolGrandExchangeEntity.new(self._client, opts)
end
...
function OldSchoolGrandExchangeEntity:mark_deleted()
  self._deleted = true
end


function OldSchoolGrandExchangeEntity:deleted()
  return true == self._deleted
end


function OldSchoolGrandExchangeEntity:data_set(args)
  if args ~= nil then
...
function OldSchoolGrandExchangeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OldSchoolGrandExchangeEntity:match_set(args)
  if args ~= nil then
...
function OldSchoolGrandExchangeEntity:match_get()
...
function OldSchoolGrandExchangeEntity:stream(action, args, callopts)
...
function OldSchoolGrandExchangeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OldSchoolGrandExchangeEntity
