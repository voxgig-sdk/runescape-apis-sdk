...
local SDK_MODULE = "runescape-apis_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["grand_exchange_database"] = { ["test01"] = { id = "test01" } }, ["old_school_grand_exchange"] = { ["test01"] = { id = "test01" } }, ["player_ranking"] = { ["test01"] = { id = "test01" } } } }'
