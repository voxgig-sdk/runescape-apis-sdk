...
function runner.env_override(m)
  local live = runner.getenv("RUNESCAPEAPIS_TEST_LIVE")
  local override = runner.getenv("RUNESCAPEAPIS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RUNESCAPEAPIS_TEST_EXPLAIN")
