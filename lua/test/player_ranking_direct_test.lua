...
describe("PlayerRankingDirect", function()
  it("should direct-list-player_ranking", function()
    local setup = player_ranking_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-player_ranking", setup.live and "live" or "unit")
...
function player_ranking_direct_setup(mockres)
