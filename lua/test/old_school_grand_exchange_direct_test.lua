...
describe("OldSchoolGrandExchangeDirect", function()
  it("should direct-list-old_school_grand_exchange", function()
    local setup = old_school_grand_exchange_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-old_school_grand_exchange", setup.live and "live" or "unit")
...
function old_school_grand_exchange_direct_setup(mockres)
