...
describe("OldSchoolGrandExchangeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set RUNESCAPEAPIS_TEST_OLD_SCHOOL_GRAND_EXCHANGE_ENTID JSON to run live")
      return
    end
...
function old_school_grand_exchange_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("RUNESCAPEAPIS_TEST_OLD_SCHOOL_GRAND_EXCHANGE_ENTID")
