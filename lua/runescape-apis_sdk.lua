...
local RunescapeApisSDK = {}
RunescapeApisSDK.__index = RunescapeApisSDK
...
RunescapeApisSDK._make_feature = _make_feature


function RunescapeApisSDK.new(options)
  local self = setmetatable({}, RunescapeApisSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function RunescapeApisSDK:options_map()
...
function RunescapeApisSDK:get_utility()
  return Utility.copy(self._utility)
end


function RunescapeApisSDK:get_root_ctx()
  return self._rootctx
end


function RunescapeApisSDK:prepare(fetchargs)
...
function RunescapeApisSDK:direct(fetchargs)
...
-- by passing it.
function RunescapeApisSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function RunescapeApisSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "RunescapeApisSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function RunescapeApisSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = RunescapeApisSDK.new(sdkopts)
  sdk.mode = "test"
