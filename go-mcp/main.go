// Command RunescapeApis-mcp is an MCP server exposing the RunescapeApis
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RunescapeApis_list  — list records of an entity
//	RunescapeApis_load  — load a single record of an entity
//
