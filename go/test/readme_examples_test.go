...
const testSeed = `map[string]any{"entity": map[string]any{"grand_exchange_database": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "old_school_grand_exchange": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player_ranking": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
