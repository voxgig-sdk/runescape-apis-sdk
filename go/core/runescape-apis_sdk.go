...
func (sdk *RunescapeApisSDK) OptionsMap() map[string]any {
...
func (sdk *RunescapeApisSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RunescapeApisSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RunescapeApisSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RunescapeApisSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RunescapeApisSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RunescapeApisSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RunescapeApisSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RunescapeApisSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RunescapeApisSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RunescapeApisSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RunescapeApisSDK {
	...
	sdk := NewRunescapeApisSDK(sdkopts)
	sdk.Mode = "test"
