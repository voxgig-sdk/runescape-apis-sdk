...
The Golang SDK for the RunescapeApis API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/runescape-apis-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/runescape-apis-sdk=../path/to/github.com/voxgig-sdk/runescape-apis-sdk
```
...
```
github.com/voxgig-sdk/runescape-apis-sdk/
...
The root package (`github.com/voxgig-sdk/runescape-apis-sdk`) re-exports everything needed
