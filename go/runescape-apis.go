...
// instead of `sdk.NewRunescapeApisSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RunescapeApisSDK  { return NewRunescapeApisSDK(nil) }
func Test() *RunescapeApisSDK { return TestSDK(nil, nil) }
