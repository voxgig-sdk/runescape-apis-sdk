...
type PlayerRankingEntity struct {
	name    string
...
func NewPlayerRankingEntity(client *core.RunescapeApisSDK, entopts map[string]any) *PlayerRankingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlayerRankingEntity) GetName() string { return e.name }
...
func (e *PlayerRankingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlayerRankingEntity) Deleted() bool {
	return e.deleted
}


func (e *PlayerRankingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlayerRankingEntity(e.client, opts)
}

func (e *PlayerRankingEntity) Data(args ...any) any {
...
func (e *PlayerRankingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PlayerRanking; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlayerRankingEntity) DataTyped(data ...PlayerRanking) PlayerRanking {
	if len(data) > 0 {
		return typedFrom[PlayerRanking](e.Data(asMap(data[0])))
	}
	return typedFrom[PlayerRanking](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PlayerRanking (all fields
// optional at the wire level).
func (e *PlayerRankingEntity) MatchTyped(match ...PlayerRanking) PlayerRanking {
	if len(match) > 0 {
		return typedFrom[PlayerRanking](e.Match(asMap(match[0])))
	}
	return typedFrom[PlayerRanking](e.Match())
}
...
func (e *PlayerRankingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlayerRankingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PlayerRankingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlayerRankingListMatch and returns []PlayerRanking. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PlayerRankingEntity) ListTyped(reqmatch PlayerRankingListMatch, ctrl map[string]any) ([]PlayerRanking, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[PlayerRanking](res), nil
}



func (e *PlayerRankingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlayerRankingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlayerRankingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlayerRankingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
