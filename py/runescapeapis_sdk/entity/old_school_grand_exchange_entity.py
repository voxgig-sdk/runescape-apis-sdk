...
from runescapeapis_sdk.runescapeapis_types import (
...
class OldSchoolGrandExchangeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OldSchoolGrandExchangeEntity(self._client, opts)
    ...
    def data_get(self) -> OldSchoolGrandExchange:
    ...
    def match_get(self) -> OldSchoolGrandExchange:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OldSchoolGrandExchange]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OldSchoolGrandExchange().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
