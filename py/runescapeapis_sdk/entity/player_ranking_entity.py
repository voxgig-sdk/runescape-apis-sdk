...
class PlayerRankingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PlayerRankingEntity(self._client, opts)
    ...
    def data_get(self) -> PlayerRanking:
    ...
    def match_get(self) -> PlayerRanking:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[PlayerRanking]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.PlayerRanking().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
