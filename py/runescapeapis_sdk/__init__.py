...
from runescapeapis_sdk.utility import register

# Load features
from runescapeapis_sdk.feature.base_feature import RunescapeApisBaseFeature
from runescapeapis_sdk.features import _has_feature, _make_feature
...
class RunescapeApisSDK:
    ...
    def get_utility(self):
        return RunescapeApisUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RunescapeApisSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GrandExchangeDatabase(self, data=None) -> "GrandExchangeDatabaseEntity":
        ...
        from runescapeapis_sdk.entity.grand_exchange_database_entity import GrandExchangeDatabaseEntity
    ...
    def OldSchoolGrandExchange(self, data=None) -> "OldSchoolGrandExchangeEntity":
        ...
        from runescapeapis_sdk.entity.old_school_grand_exchange_entity import OldSchoolGrandExchangeEntity
    ...
    def PlayerRanking(self, data=None) -> "PlayerRankingEntity":
        ...
        from runescapeapis_sdk.entity.player_ranking_entity import PlayerRankingEntity
