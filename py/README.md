...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GrandExchangeDatabase()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/runescape-apis-sdk/releases)) or
