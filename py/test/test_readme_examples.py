# RunescapeApis SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RunescapeApisSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RunescapeApisSDK(...) and RunescapeApisSDK.test(...) become
#      RunescapeApisSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "runescapeapis_sdk"
_SDK_CLASS = "RunescapeApisSDK"
...
_ENTITIES = {
    "GrandExchangeDatabase": "grand_exchange_database",
    "OldSchoolGrandExchange": "old_school_grand_exchange",
