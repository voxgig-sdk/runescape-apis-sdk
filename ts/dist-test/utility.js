...
function envOverride(m) {
    if ('TRUE' === process.env.RUNESCAPE_APIS_TEST_LIVE ||
        'TRUE' === process.env.RUNESCAPE_APIS_TEST_OVERRIDE) {
    ...
    m.RUNESCAPE_APIS_TEST_EXPLAIN = process.env.RUNESCAPE_APIS_TEST_EXPLAIN || m.RUNESCAPE_APIS_TEST_EXPLAIN;
    return m;
}
