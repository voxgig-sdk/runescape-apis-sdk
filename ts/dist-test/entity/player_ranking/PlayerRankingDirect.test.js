...
(0, node_test_1.describe)('PlayerRankingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-player_ranking', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-player_ranking', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RUNESCAPE_APIS_TEST_PLAYER_RANKING_ENTID'];
...
//# sourceMappingURL=PlayerRankingDirect.test.js.map