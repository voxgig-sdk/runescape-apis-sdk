...
(0, node_test_1.describe)('OldSchoolGrandExchangeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-old_school_grand_exchange', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-old_school_grand_exchange', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['RUNESCAPE_APIS_TEST_OLD_SCHOOL_GRAND_EXCHANGE_ENTID'];
...
//# sourceMappingURL=OldSchoolGrandExchangeDirect.test.js.map