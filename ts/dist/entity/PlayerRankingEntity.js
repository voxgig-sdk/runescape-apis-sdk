...
class PlayerRankingEntity extends RunescapeApisEntityBase_1.RunescapeApisEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'player_ranking';
        this.name_ = 'player_ranking';
        this.Name = 'PlayerRanking';
    }
    make() {
        return new PlayerRankingEntity(this._client, this.entopts());
    }
...
exports.PlayerRankingEntity = PlayerRankingEntity;
//# sourceMappingURL=PlayerRankingEntity.js.map