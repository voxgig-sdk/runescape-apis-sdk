...
The TypeScript SDK for the RunescapeApis API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new RunescapeApisSDK({ apikey: '...' })
