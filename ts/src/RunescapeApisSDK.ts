...
class RunescapeApisSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('RunescapeApisSDK: graphql: ' +
  ...
  GrandExchangeDatabase(entopts?: Record<string, any>) {
    const self = this
    return new GrandExchangeDatabaseEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  OldSchoolGrandExchange(entopts?: Record<string, any>) {
    const self = this
    return new OldSchoolGrandExchangeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  PlayerRanking(entopts?: Record<string, any>) {
    const self = this
    return new PlayerRankingEntity(self, entopts)
  }
