...
|---|---|---|
| `ts/` | @voxgig-sdk/runescape-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/runescape-apis-sdk \
      --repository voxgig-sdk/runescape-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/runescape-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/runescape-apis-sdk --id=<id>` removes it.
