...
from projectname_sdk.core.control import RunescapeApisControl
...
class RunescapeApisContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RunescapeApisControl()
        ...
        if isinstance(sp, RunescapeApisSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RunescapeApisResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RunescapeApisResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RunescapeApisError(code, msg, self)
