...
// RunescapeApis SDK pipeline test
//
...
{
    private static function utility(): RunescapeApisUtility
    {
        return new RunescapeApisUtility();
    }
    ...
    private static function ctx(array $over = []): RunescapeApisContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RunescapeApisContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RunescapeApisOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RunescapeApisError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RunescapeApisOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RunescapeApisMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RunescapeApisOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RunescapeApisMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RunescapeApisOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RunescapeApisMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RunescapeApisSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RunescapeApisMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RunescapeApisResponse([]),
            'result' => new RunescapeApisResult([]),
        ]);
        [, $err] = RunescapeApisMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec([]),
            'response' => null,
            'result' => new RunescapeApisResult([]),
        ]);
        [, $err] = RunescapeApisMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec(['step' => 's']),
            'response' => new RunescapeApisResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RunescapeApisResult([]),
        ]);
        [, $err] = RunescapeApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec(['step' => 's']),
            'response' => new RunescapeApisResponse(self::resp(200, ['v' => 1])),
            'result' => new RunescapeApisResult([]),
        ]);
        [, $err] = RunescapeApisMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec(['step' => 's']),
            'response' => new RunescapeApisResponse(self::resp(200, ['v' => 2])),
            'result' => new RunescapeApisResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RunescapeApisMakeResponse::call($ctx);
    ...
    {
        $preset = new RunescapeApisResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec([]),
            'response' => new RunescapeApisResponse([]),
            'result' => new RunescapeApisResult([]),
        ...
        [$got, $err] = RunescapeApisMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RunescapeApisResult([])]);
        [, $err] = RunescapeApisMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RunescapeApisSpec([]), 'result' => null]);
        [, $err] = RunescapeApisMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RunescapeApisSpec(['step' => 's']),
            'result' => new RunescapeApisResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RunescapeApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RunescapeApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RunescapeApisSpec(['step' => 's']),
            'result' => new RunescapeApisResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RunescapeApisOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RunescapeApisMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RunescapeApisResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RunescapeApisSpec([]),
            'result' => new RunescapeApisResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RunescapeApisMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RunescapeApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RunescapeApisError('boom', 'boom');
        $utility->fetcher = function (RunescapeApisContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RunescapeApisSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RunescapeApisMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RunescapeApisContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RunescapeApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RunescapeApisResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RunescapeApisMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RunescapeApisContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RunescapeApisSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RunescapeApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RunescapeApisResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RunescapeApisSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RunescapeApisMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RunescapeApisMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RunescapeApisMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RunescapeApisResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RunescapeApisDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RunescapeApisResult(['ok' => false])]);
        $this->expectException(RunescapeApisError::class);
        RunescapeApisDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RunescapeApisResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RunescapeApisMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RunescapeApisMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RunescapeApisBaseFeature();
        $b = new RunescapeApisBaseFeature();
        RunescapeApisFeatureAdd::call($ctx, $a);
        RunescapeApisFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RunescapeApisBaseFeature
    {
        $f = new RunescapeApisBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RunescapeApisFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RunescapeApisContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RunescapeApisSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RunescapeApisPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RunescapeApisPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RunescapeApisResponse(['headers' => null]),
            'result' => new RunescapeApisResult([]),
        ]);
        RunescapeApisResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RunescapeApisResultBody::call($ctx);
