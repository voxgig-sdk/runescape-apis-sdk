...
// RunescapeApis SDK proxy feature
...
class RunescapeApisProxyFeature extends RunescapeApisBaseFeature
{
    ...
    public function init(RunescapeApisContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RunescapeApisContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
