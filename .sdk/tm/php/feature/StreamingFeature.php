...
// RunescapeApis SDK streaming feature
...
class RunescapeApisStreamingFeature extends RunescapeApisBaseFeature
{
    ...
    private function _iterate(RunescapeApisResult $result): \Generator
    {
    ...
    private function _streamable(RunescapeApisContext $ctx): bool
    {
