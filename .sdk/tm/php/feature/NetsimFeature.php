...
// RunescapeApis SDK netsim feature
...
class RunescapeApisNetsimFeature extends RunescapeApisBaseFeature
{
    ...
    private function _simulate(RunescapeApisContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RunescapeApisContext $ctx, array $applied): void
    {
        $client = $this->client;
