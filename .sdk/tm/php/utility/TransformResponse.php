...
// RunescapeApis SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RunescapeApisTransformResponse
{
    public static function call(RunescapeApisContext $ctx): mixed
    {
        ...
        $transform = RunescapeApisHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
