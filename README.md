...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/runescape-apis` | `npm install @voxgig-sdk/runescape-apis` |
| Python | `voxgig-sdk-runescape-apis` | `pip install voxgig-sdk-runescape-apis` |
| PHP | `voxgig-sdk/runescape-apis` | `composer require voxgig-sdk/runescape-apis` |
| Golang | `github.com/voxgig-sdk/runescape-apis-sdk/go` | `go get github.com/voxgig-sdk/runescape-apis-sdk/go` |
| Ruby | `voxgig-sdk-runescape-apis` | `gem install voxgig-sdk-runescape-apis` |
| Lua | `voxgig-sdk-runescape-apis` | `luarocks install voxgig-sdk-runescape-apis` |
